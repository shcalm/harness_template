...
This file records execution state only. Long-term business intent goes in `PRD.md`, long-term technical knowledge in `DESIGN.md`, and verification results in `TEST_REPORT.md`.
...
| Status | TASK-ID | Main Task | Linked REQ/AC | Completion Criteria | Verification Reference |
| :--- | :--- | :--- | :--- | :--- | :--- |
| [/] | TASK-001 | `[Current main task]` | REQ-001 / AC-001 | `[What counts as done]` | TEST-001 |
| [ ] | TASK-002 | `[Next main task]` | REQ-002 / AC-002 | `[Completion criteria]` | `[To be generated]` |

## 3. Current Task Breakdown: TASK-001

| Status | Subtask | Action | Evidence / Output |
| :--- | :--- | :--- | :--- |
| [ ] | TASK-001.1 | `[Reproduce / add logs / add tests]` | `[Log path or test name]` |
...
| Status | Subtask | Action | Evidence / Output |
| :--- | :--- | :--- | :--- |
| [x] | TASK-001.1 | Add upload-success test | TEST-001 |
